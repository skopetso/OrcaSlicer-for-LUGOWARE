...
static const wxColour BUTTON_HOVER_COL   = wxColour(0, 151, 137);
...
static const wxColour STAGE_TEXT_COL      = wxColour(0, 151, 137);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(0, 151, 137));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(0, 151, 137));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(0, 151, 137));
        });
