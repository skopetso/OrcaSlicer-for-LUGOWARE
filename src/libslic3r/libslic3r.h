...
#define SLIC3R_APP_FULL_NAME "LUGOWARE_ORCA slicer"
#define GCODEVIEWER_APP_NAME "LUGOWARE_ORCA G-code Viewer"
#define GCODEVIEWER_APP_KEY  "LugowareOrcaGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("LUGOWARE_ORCA G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
