...
static std::vector<std::string> s_Preset_print_options {
    ...
    "fuzzy_skin", "fuzzy_skin_thickness", "fuzzy_skin_point_distance", "fuzzy_skin_first_layer", "fuzzy_skin_noise_type", "fuzzy_skin_mode", "fuzzy_skin_scale", "fuzzy_skin_octaves", "fuzzy_skin_persistence", "fuzzy_skin_layer_step",
    ...
    "elefant_foot_compensation", "elefant_foot_compensation_layers", "xy_contour_compensation", "xy_contour_compensation_layer_step", "xy_hole_compensation", "xy_hole_compensation_layer_step", "resolution", "enable_prime_tower", "prime_tower_enable_framework",
