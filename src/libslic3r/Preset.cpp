...
static std::vector<std::string> s_Preset_print_options {
    ...
    "infill_direction", "solid_infill_direction", "counterbore_hole_bridging","infill_shift_step", "lugolinear_step_layers", "sparse_infill_rotate_template", "solid_infill_rotate_template", "symmetric_infill_y_axis","skeleton_infill_density", "infill_lock_depth", "skin_infill_depth", "skin_infill_density",
...
static std::vector<std::string> s_Preset_filament_options {/*"filament_colour", */ "default_filament_colour", "required_nozzle_HRC", "filament_diameter", "pellet_flow_coefficient", "volumetric_speed_coefficients", "filament_type",
    ...
    "filament_toolchange_slowdown_speed_ratio", "filament_toolchange_slowdown_distance", "filament_toolchange_slowdown_additional_temp", "filament_additional_prime", "filament_cell_zhop_height", "filament_dhop_ratio", "retract_restart_extra_toolchange",
